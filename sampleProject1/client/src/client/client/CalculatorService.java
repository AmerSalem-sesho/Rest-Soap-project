 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://SoapService/", wsdlLocation = "http://localhost:8888/cal?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://SoapService/", "CalculatorService");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://SoapService/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://SoapService/", "CalculatorPort"), Calculator.class, features);
    }
