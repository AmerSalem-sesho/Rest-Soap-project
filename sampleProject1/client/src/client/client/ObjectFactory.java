...
public class ObjectFactory {
    ...
    private final static QName _Sub_QNAME = new QName("http://SoapService/", "sub");
    private final static QName _SubResponse_QNAME = new QName("http://SoapService/", "subResponse");
    private final static QName _Add_QNAME = new QName("http://SoapService/", "add");
    private final static QName _Div_QNAME = new QName("http://SoapService/", "div");
    private final static QName _DivResponse_QNAME = new QName("http://SoapService/", "divResponse");
    private final static QName _Mul_QNAME = new QName("http://SoapService/", "mul");
    private final static QName _MulResponse_QNAME = new QName("http://SoapService/", "mulResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://SoapService/", name = "sub")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://SoapService/", name = "subResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://SoapService/", name = "div")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://SoapService/", name = "divResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://SoapService/", name = "mul")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://SoapService/", name = "mulResponse")
